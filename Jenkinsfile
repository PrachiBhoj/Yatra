        ...
        stage('Upload the docker Image to Nexus') {
           steps {
              script {
                 ...
                 sh 'docker login http://172.31.90.171:8085/repository/yatra -u admin -p ${PASSWORD}'
                 echo "Push Docker Image to Nexus : In Progress"
                 sh 'docker tag http://172.31.90.171:8085/yatra:latest'
                 sh 'docker push 172.31.90.171:8085/yatra'
